...
class DynamicLayoutService {
  ...
  Widget _buildSimpleWidget(
    ...
    // Convert Shopware CMS data to real layout
    return SingleChildScrollView(
      child: Container(
        padding: const EdgeInsets.all(16.0),
        child: Column(
              ...
              children: [
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Shopware CMS entegrasyonu çalışıyor!'),
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    onPressed: () {
                      // Show JSON data
                      _showJsonDialog(context, layoutData);
                    },
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Shopware 6 CMS entegrasyonu başarıyla çalışıyor!',
                      style: TextStyle(
                        fontSize: 16,
                        color: Colors.green,
  ...
  void _showJsonDialog(BuildContext context, Map<String, dynamic> data) {
    showDialog(
      context: context,
